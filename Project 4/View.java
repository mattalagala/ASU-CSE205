...
public class View extends JFrame implements ActionListener {
     ...
     * ElseIf the source of the event was mEvalButton Then Call evaluate() ElseIf
     * the source of the event was mExitButton Then Call exit() on mMain. End If
     */
    @Override
     ...
     *
     * PSEUDOCODE: Retrieve the text string from mInputText Declare and create an
     * Expression object named expr passing the text string to the ctor Call
